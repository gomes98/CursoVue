<template>
  <div class="article-admin">
    <b-form>
      ...
      <b-form-group label="Descrição:" label-for="article-descrption">
        <b-form-input
          id="article-descrption"
          type="text"
          v-model="article.description"
          required
          :readonly="mode === 'remove'"
          placeholder="Informe o Descição do Artigo"
        />
      </b-form-group>
      <b-form-group label="Imagem (URL):" label-for="article-imageUrl">
        <b-form-input
          ...
          required
          :readonly="mode === 'remove'"
          placeholder="Informe a URL Imagem do Artigo"
        />
      </b-form-group>
      ...
      <b-form-group v-if="mode === 'save'" label="Conteudo:" label-for="article-parentId">
        <VueEditor
  ...
  methods: {
    ...
    loadArticle(article, mode = "save") {
      ...
      axios
        ...
        .then((res) => (this.article = res.data)).catch(showError);
    },
    loadCategories() {
